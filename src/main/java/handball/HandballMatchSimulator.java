...
public class HandballMatchSimulator implements MatchSimulator {

    private static final int HANDBALL_PERIODS = 2;
    ...
    public HandballMatchSimulator(MatchFlow matchFlow, RosterRule rosterRule,
                                 HandballScoringRule scoringRule, Random random) {
    ...
    public MatchResult simulateMatch(Match match) {
        ...
        for (int i = 1; i <= HANDBALL_PERIODS; i++) {
